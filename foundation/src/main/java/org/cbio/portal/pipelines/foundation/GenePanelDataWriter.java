 ...
 * @author ochoaa
 */
public class GenePanelDataWriter implements ItemStreamWriter <CompositeResultBean> {
   ...
   @Value("#{jobParameters[outputDirectory]}")
    ...
    public void open(ExecutionContext executionContext) throws ItemStreamException {
        File stagingFile = new File(outputDirectory, "data_gene_matrix.txt");
    ...
    public String getHeader(){
        ...
        Map<String, String> map = new GenePanelData().getStagingMap();
    ...
    public void write(List<? extends CompositeResultBean> items) throws Exception {
        ...
        for (CompositeResultBean result : items) {
            writeList.add(result.getGenePanelDataResult());
        }
